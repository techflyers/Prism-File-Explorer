...
public class WorkbookReader
{
    ...
    {        
        ...
        public void run()
        {
            ...
            { 
                if (control != null && control.getSysKit() != null)
                {
     ...
     * @param sheetsRel
     */
    public void readSheet(IControl control, int index) throws Exception
    {
        ...
        if(sheetPart != null)
        {
            ...
            {    
                if (!sheet.isAccomplished())
                {
                    ...
                    SheetReader.instance().getSheet(control, zipPackage, sheet, sheetPart, iReader);             
                }
            }     
    ...
    class WorkBookSaxHandler implements ElementHandler
    {
        ...
        public void onEnd(ElementPath elementPath)
        {
            ...
            else if(name.equals("workbookPr"))
            {
                ...
                {
                    String val = elem.attributeValue("date1904");
                    usingDate1904 = "true".equalsIgnoreCase(val) || "1".equals(val);
                }
