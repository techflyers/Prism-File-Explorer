package com.techflyers.compose.file.explorer.screen.main.tab.files.service.remote
...
object NetworkConnectionsService {
    ...
    fun notifyRootsChanged(context: Context) {
        try {
            val rootsUri = android.provider.DocumentsContract.buildRootsUri("com.techflyers.compose.file.explorer.documents")
