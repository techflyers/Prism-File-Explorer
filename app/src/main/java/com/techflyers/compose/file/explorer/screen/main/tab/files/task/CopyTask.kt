...
import com.techflyers.compose.file.explorer.common.listFilesAndEmptyDirs
...
import com.techflyers.compose.file.explorer.common.toRelativeString
...
import com.techflyers.compose.file.explorer.screen.main.tab.files.shizuku.ShizukuFileEntry
...
class CopyTask(
    ...
    private fun getUniqueRemotePath(client: com.techflyers.compose.file.explorer.screen.main.tab.files.service.remote.RemoteClient, remotePath: String): String {
