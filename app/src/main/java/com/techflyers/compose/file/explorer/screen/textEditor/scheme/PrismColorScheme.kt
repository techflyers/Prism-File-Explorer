package com.techflyers.compose.file.explorer.screen.textEditor.scheme
...
object PrismColorScheme {
    ...
    fun applyTheme(codeEditor: CodeEditor, context: Context, isTextMate: Boolean = true) {
        ...
        val userTheme = com.techflyers.compose.file.explorer.App.Companion.globalClass.preferencesManager.textEditorTheme
