package com.techflyers.compose.file.explorer
...
import com.techflyers.compose.file.explorer.coil.zip.ZipFileKeyer
import com.techflyers.compose.file.explorer.common.FileExplorerLogger
...
import com.techflyers.compose.file.explorer.screen.preferences.PreferencesManager
import com.techflyers.compose.file.explorer.screen.textEditor.TextEditorManager
...
class App : Application(), coil3.SingletonImageLoader.Factory {
    ...
    private fun setupTextMate() {
        applicationScope.launch {
            try {
                val zipResolver = com.techflyers.compose.file.explorer.screen.textEditor.language.ZipFileResolver.getInstance(appContext)
                if (zipResolver != null) {
